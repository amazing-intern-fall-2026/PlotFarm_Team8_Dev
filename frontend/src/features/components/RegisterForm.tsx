    ...
    <div className="space-y-6">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {error && (
          ...
          >
            ...
            <div className="flex-1">
              <span className="font-semibold">Lỗi đăng ký: </span>
              <span>{error}</span>
            </div>
            <button
              type="button"
        ...
        {successMessage && (
          <div
            role="status"
            className="flex items-center gap-3 rounded-lg border border-emerald-200 bg-emerald-50 p-3.5 text-sm text-emerald-800"
          >
            <svg
